...
if __name__ == "__main__":
    input_file = "F:/Research_Project/EP_ukb/Revision_medicine/medicine_screening/20003.csv"  # 替换为您的输入文件路径
    output_file = "F:/Research_Project/EP_ukb/Revision_medicine/asm_type_screening_results.csv"  # 替换为您的输出文件路径
